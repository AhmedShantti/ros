 ...
 *
 * The imports are the five contexts a truthful BR-POS-004 snapshot needs:
 * Catalogue for price and item identity, Localisation for the pack and the tax
 * class, Production for the recipe version and its cost, Identity for the POS
 * session, Governance for the audit chain. Nothing is duplicated here — this
 * module orchestrates, it does not re-derive.
 *
 * STILL UNEXPOSED: fire, complete, payment and refund. Firing has real KDS
 * consequences and completion must drive fiscal documents, inventory depletion,
 * COGS posting and drawer attribution; none of those exist, and a state flip
